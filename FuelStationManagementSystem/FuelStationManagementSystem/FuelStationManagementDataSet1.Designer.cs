...
namespace FuelStationManagementSystem {
    ...
    public partial class FuelStationManagementDataSet1 : global::System.Data.DataSet {
        ...
        public partial class CustomerDataTable : global::System.Data.TypedTableBase<CustomerRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public CustomerRow AddCustomerRow(System.Guid ID, string Name, string Surname, string CardNumber) {
    ...
    public partial class CustomerTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Customer] WHERE (([ID] = @Original_ID) AND ([Name] = @Original" +
                "_Name) AND ([Surname] = @Original_Surname) AND ([CardNumber] = @Original_CardNum" +
                "ber))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Customer] ([ID], [Name], [Surname], [CardNumber]) VALUES (@ID," +
                " @Name, @Surname, @CardNumber);\r\nSELECT ID, Name, Surname, CardNumber FROM Custo" +
                "mer WHERE (ID = @ID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Customer] SET [ID] = @ID, [Name] = @Name, [Surname] = @Surname, [CardNumber] = @CardNumber WHERE (([ID] = @Original_ID) AND ([Name] = @Original_Name) AND ([Surname] = @Original_Surname) AND ([CardNumber] = @Original_CardNumber));
SELECT ID, Name, Surname, CardNumber FROM Customer WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Name, Surname, CardNumber FROM dbo.Customer";
        ...
        public virtual int Fill(FuelStationManagementDataSet1.CustomerDataTable dataTable) {
        ...
        public virtual FuelStationManagementDataSet1.CustomerDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            FuelStationManagementDataSet1.CustomerDataTable dataTable = new FuelStationManagementDataSet1.CustomerDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(FuelStationManagementDataSet1.CustomerDataTable dataTable) {
        ...
        public virtual int Delete(System.Guid Original_ID, string Original_Name, string Original_Surname, string Original_CardNumber) {
        ...
        public virtual int Insert(System.Guid ID, string Name, string Surname, string CardNumber) {
        ...
        public virtual int Update(System.Guid ID, string Name, string Surname, string CardNumber, System.Guid Original_ID, string Original_Name, string Original_Surname, string Original_CardNumber) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Surname, string CardNumber, System.Guid Original_ID, string Original_Name, string Original_Surname, string Original_CardNumber) {
            return this.Update(Original_ID, Name, Surname, CardNumber, Original_ID, Original_Name, Original_Surname, Original_CardNumber);
        }
    }
